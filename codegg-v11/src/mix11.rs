...
impl Mix11 {
    ...
    pub fn export_prior(&self) -> String {
        ...
        out.push_str("//! GENERATED by `eggv11 gen-prior` from the site's book (the test page\n");
        out.push_str("//! excluded). Regenerate and byte-compare; never edit.\n");
        out.push_str("pub const PRIOR_ON: bool = true;\n");
        ...
        dump_i32(&mut out, "PRIOR_W", &self.w);
        dump_u8(&mut out, "PRIOR_H1", &self.h1);
        dump_u8(&mut out, "PRIOR_H2", &self.h2);
        dump_u8(&mut out, "PRIOR_O1S", &self.o1s);
        out.push_str(&format!("pub static PRIOR_SM1: [u32; {}] = [", self.sm1.dump().len()));
