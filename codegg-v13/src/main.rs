...
fn main() -> ExitCode {
    ...
    let usage = || {
        eprintln!("usage: eggv13 transmute <file> [-o out.egg13] [--no-armor] [--survive BYTES] [--tier BLK] [--parity T] [--ct triple|incw|none] [--judge]");
        eprintln!("       eggv13 restore <file.egg13 | .egg12 | .egg11 | .egg10 | .egg9 | .egg8> [-o out] [--wound start:len] [--no-doubles]");
    ...
    match cmd {
        "transmute" => {
            ...
            let dst = get("-o").unwrap_or(format!("{}.egg13", path));
